...
namespace NotchCpu.CompilerTasks
{
    ...
    public class CSharpGrammar : Irony.Parsing.Grammar
    {
        ...
        public CSharpGrammar()
        {
            ...
            var functionDeclaration = new NonTerminal("Function Declaration", typeof(FunctionDeclarationNodeCSharp));
            ...
            var functionCall = new NonTerminal("Function Call", typeof(FunctionCallNodeCSharp));
            var staticFunctionCall = new NonTerminal("Static Function Call", typeof(FunctionCallNodeCSharp));
